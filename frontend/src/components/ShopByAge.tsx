...
const ages = [
  { label: "0–3 Months", sub: "Newborn essentials", image: age03, ageRange: "0-24", path: "/collections/newborn" },
  { label: "6–12 Months", sub: "Active little ones", image: age612, ageRange: "6-12", path: "/collections/girls" },
  { label: "1–10 Years", sub: "Kids fashion & comfort", image: age110, ageRange: "1-10", path: "/collections/unisex" },
  { label: "2–10 Years", sub: "Premium style & play", image: age210, ageRange: "2-10", path: "/collections/unisex" },
  { label: "2–12 Years", sub: "Growing & exploring", image: age36, ageRange: "2-12", path: "/collections/boys" },
];
